...
function main() {
    ...
    function startGame(saveData) {
        ...
        if (saveData && saveData.player) {
            ...
            // Восстанавливаем физику после телепортации
            ...
            // Генерируем данные чанка (0,0) принудительно, чтобы знать высоту
