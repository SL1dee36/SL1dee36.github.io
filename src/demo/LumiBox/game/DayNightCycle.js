...
export class DayNightCycle extends Component {
    ...
    createCelestialBodies() {
        ...
        const sT = this.createTexture(64, (c, w) => {
            c.fillStyle = '#FFF700'; c.fillRect(0, 0, w, w);
            c.fillStyle = '#FFD700'; c.fillRect(w / 4, w / 4, w / 2, w / 2);
        });
        ...
        const mT = this.createTexture(64, (c, w) => {
            c.fillStyle = '#F0F0F0'; c.fillRect(0, 0, w, w);
            c.fillStyle = '#CCCCCC'; c.fillRect(w / 8, w / 8, w / 4, w / 4);
            c.fillRect(w / 2, w / 2, w / 3, w / 3);
        });
    ...
    update(dt) {
        ...
        if (sunHeight > 0.2) {
            ...
            if (sunHeight > 0) {
                ...
                this.currentSkyColor.copy(this.nightColor).lerp(this.sunsetColor, t);
            }
        } else {
            this.currentSkyColor.copy(this.nightColor);
        }
